...
class App:
    def __init__(self):
        self.figures = {
            ...
            # Non Fractals
            "ReguralPolygon": ReguralPolygon.ReguralPolygon,
...
app.create_figure("ReguralPolygon", 3, 0.5, it=100, animation_need=True, multi=200)
app.create_figure("DefaultPolynomialFunction", 3, 0.5, [0, 0, 0, 1], it=100, animation_need=True, multi=200)
