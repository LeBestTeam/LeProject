...
app.create_figure("ArchimedeanSpiral", 0.5, 0.2, animation_need=True, multi=100, animation_save=False)
app.create_figure("CardioidCurve", 1.0, animation_need=True, multi=20, animation_save=False)
app.create_figure("LissajousCurve", 1.0, 2.0, np.pi/2, animation_need=True, animation_save=False)
app.create_figure("LissajousCurve", 3.0, 2.0, np.pi/2, animation_need=True, multi=100, animation_save=False)
app.create_figure("LissajousCurve", 3.0, 4.0, np.pi/2, animation_need=True, multi=100, animation_save=False)
app.create_figure("LissajousCurve", 5.0, 4.0, np.pi/2, animation_need=True, multi=100, animation_save=False)
